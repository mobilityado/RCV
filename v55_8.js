...
<nav class="r49-bottom-nav" id="r49BottomNav">
  ...
  async function publishLocal(module){
    ...
    try{
      ...
      // v55.8: la finalización se hace por GET/JSONP, que ya comprobamos que sí llega a Apps Script.
