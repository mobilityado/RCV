...
<nav class="r49-bottom-nav" id="r49BottomNav">
  ...
  function renderData(data,module,meta={},source='cloud'){
    ...
    host.insertAdjacentHTML('beforeend',periodControls(regionRows)+compareExecutiveBlock(regionRows,module)+executiveReportBar(rows,module,meta,source)+head+
      ...
      chart+
      `<article class="rcv34-card"><div class="rcv34-card-head"><div><h3>2. Cuentas contables de la región</h3><p>Selecciona una cuenta para ver exactamente a qué gerencias, áreas, centros y conceptos afecta; cada afectación conserva su semáforo y seguimiento.</p></div>${noteBtn}</div>
