  ...
  async function exportPdf(element, filename, title){
    ...
    try{
      ...
      while(sy<canvas.height){
        ...
        pdf.text('REPORT.IA RCV · Executive Command Center 17.1',margin,10);pdf.text('Página '+page,pw-margin,10,{align:'right'});
  ...
  async function generateFinalPackage(){
    ...
    try{
      ...
      if(typeof JSZip!=='undefined'){
        ...
        const summary=[
          'REPORT.IA RCV · Executive Command Center 17.1',
          '',
          `Periodo: ${month}`,
