...
<nav class="r49-bottom-nav" id="r49BottomNav">
  ...
  async function loadSystemHealth(){
    try{
      ...
      host.insertAdjacentHTML('beforeend',`<div class="r521-health"><span>ESTADO DEL CANAL</span><div><b>${sent===total&&total>0?'✅ Push operativo':'⚠ Revisar entrega'}</b><small>Último envío: ${sent}/${total} dispositivo(s) · ${esc(x.gerencia||'')}</small></div><div><b>Portal v53.0</b><small>Android v2.0 · Firebase + TWA</small></div></div>`);
    }catch(_){ }
  }
