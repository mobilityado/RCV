...
<nav class="r49-bottom-nav" id="r49BottomNav">
  ...
  function compareExecutiveBlock(regionRows,module){
    ...
    const names=[...new Set([...aRows.map(keyFn),...bRows.map(keyFn)])];
    const items=names.map(name=>{
      const a=totals(aRows.filter(r=>keyFn(r)===name),module),b=totals(bRows.filter(r=>keyFn(r)===name),module),metric=compareMetric(module,a.real,b.real),trend=evolutionTag(module,a,b);
