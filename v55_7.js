...
<nav class="r49-bottom-nav" id="r49BottomNav">
  ...
  async function publishLocal(module){
    ...
    try{
      ...
      msg.textContent='Último bloque recibido · armando publicación en Google Sheets…';
      let confirmed=null;
      for(let i=0;i<60;i++){
