...
<nav class="r49-bottom-nav" id="r49BottomNav">
  ...
  async function renderMenu(){
    ...
    const hero=`<section class="r49-hero"><div class="r49-hero-copy"><span class="r49-eyebrow">CENTRO DE INTELIGENCIA REGIONAL</span><h2>Control ejecutivo RCV</h2><p>Consulta Gastos, Costos y Productividad con navegación por Región → Cuenta contable → Impactos, comparativa interanual y seguimiento de semáforos.</p></div><div class="r49-hero-badge"><small>VERSIÓN</small><strong>51.7</strong><span>Diseño ejecutivo</span></div></section>`;
