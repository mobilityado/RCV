...
<nav class="r49-bottom-nav" id="r49BottomNav">
  ...
  function openAccount(data,module,account,meta,source='cloud'){
    ...
    const renderSummary=()=>{
      ...
      const conversation=source==='cloud'&&meta?.snapshotId?threadBlock(module,meta.snapshotId,adminRegionLabel(),key):'';
      ...
      if(conversation){loadThread(module,meta.snapshotId,adminRegionLabel(),key);if($('r34SendNote'))$('r34SendNote').onclick=()=>sendNote(module,meta.snapshotId,adminRegionLabel(),key)}
    };
