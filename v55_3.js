(() => {
  ...
  async function post(params){
    // v55.3: transporte POST restaurado desde la versión que publicaba correctamente: POST real por formulario oculto + verificación prolongada del snapshot. En algunos navegadores,
...
<nav class="r49-bottom-nav" id="r49BottomNav">
  ...
  async function publishLocal(module){
    ...
    try{
      ...
      // v55.3: mantenemos la corrección de regiones, pero restauramos exactamente el
      ...
      await post({accion:'v34_upload',token:S.session.token,module,payload:JSON.stringify(S.local)});
      let confirmed=null;
