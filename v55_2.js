(() => {
  ...
  async function post(params){
    // v55.2: envio POST directo. La respuesta queda opaca por CORS, por eso
    // la confirmacion real se hace despues consultando v34_history por JSONP.
    // A diferencia del formulario/iframe de v55.1, fetch si dispara doPost
    // de forma confiable desde GitHub Pages / dominio personalizado.
